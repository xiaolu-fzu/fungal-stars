...
function startTutorial(){
  ...
  tutor={start,stage,phase:'plant',zoom:5,targetZoom:1.5,zoomT:0,dwell:0};
...
function tickTutorial(dt){
  ...
  else if(ph==='won'){ tutor.dwell+=dt; if(tutor.dwell>=2.0){ tutor.phase='unlock'; tutor.zoomT=0; tutor.targetZoom=1.5; } } // 字幕读过 → 才慢慢拉远(结束档位 1.5)
}
